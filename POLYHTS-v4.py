#!/opt/anaconda3/envs/liam-env/bin/python3.6
...
# Read in list of smiles pairs from candidate list
...
# Read in list of smiles and generate 10,000 random smiles pairs
def random_candidates(candidate_list):
...
def main(smiles1, smiles2, tag, nconfs, length, solvent, intensity_cutoff):
    ...
    os.system('rm *.mol *wfn *log wfn.xtb charges* wbo tda.dat *rankings energy xtbrestart')
    os.chdir('../')
...
if __name__ == "__main__":
    ...
    elif random_select == True:
        candidates = random_candidates(candidate_list)
